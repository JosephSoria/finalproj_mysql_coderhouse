...
Proyecto final que plasma conocimientos desarrollados durante la cursada de MySQL en un proyecto final. Herramientas utilizadas: MySQL, mockaroo, ChatGPT, Excel, PowerBI.



### **Introducción**

Un proyecto comercial web llamado Fotografía se pone en marcha, el proyecto cuenta con varias áreas de desarrollo pero hoy nos enfocaremos en la gestión de base de datos y un breve análisis de la evolución del proyecto en alguna temática en particular, desde la fundación del proyecto en inicios del 2023.
